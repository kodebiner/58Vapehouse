...
<div class="uk-flex uk-flex-middle uk-panel uk-panel-scrollable" uk-height-viewport="offset-bottom: footer;">
	<div class="uk-width-1-1 uk-flex uk-flex-center">
        <div class="uk-card uk-card-small uk-card-default uk-card-body uk-width-1-4 uk-padding-remove">
			<div>
			...
			<div class="uk-padding-small">
				...
				<form class="uk-form-stacked" action="<?= url_to('login') ?>" method="post">
                    ...
                    <div class="uk-margin">
                        <?php if ($config->validFields === ['email']): ?>
                            ...
                            <div class="uk-form-controls">
                                <input type="email" class="uk-input <?php if (session('errors.login')) : ?>tm-form-invalid<?php endif ?>" name="login" placeholder="<?=lang('Auth.email')?>" value="<?= old('login') ?>">
                            </div>
                        ...
                        <?php else: ?>
                            ...
                            <div class="uk-form-controls">
                                <input type="text" class="uk-input <?php if (session('errors.login')) : ?>tm-form-invalid<?php endif ?>" name="login" placeholder="<?=lang('Auth.emailOrUsername')?>" value="<?= old('login') ?>">
                            </div>
                            <div class="uk-text-small uk-text-italic uk-text-danger">
                                <?= session('errors.login') ?>
                            </div>
                    ...
                    <div class="uk-margin">
                        ...
                        <div class="uk-form-controls">
                            <input type="password" name="password" class="uk-input  <?php if (session('errors.password')) : ?>tm-form-invalid<?php endif ?>" placeholder="<?=lang('Auth.password')?>">
                        </div>
                        <div class="uk-text-small uk-text-italic uk-text-danger">
