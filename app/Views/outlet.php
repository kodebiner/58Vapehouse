          ...
          <div class="uk-modal-body">
            <form class="uk-form-stacked" role="form" action="/outlet/create" method="post">
              ...
              <div class="uk-margin-bottom">
                ...
                <div class="uk-form-controls">
                  <input type="text" class="uk-input <?php if (session('errors.maps')) : ?>tm-form-invalid<?php endif ?>" id="maps" name="maps" placeholder="<?=lang('Global.address')?>" autofocus required />
                </div>
              </div>
